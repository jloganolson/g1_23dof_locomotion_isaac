...
def some_public_function(x: int):
    print("[g1_23dof_locomotion_isaac] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[g1_23dof_locomotion_isaac] startup")
    ...
    def on_shutdown(self):
        print("[g1_23dof_locomotion_isaac] shutdown")